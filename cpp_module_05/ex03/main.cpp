...
int main() {
	...
	AForm* sForm = intern.makeForm("ShrubberyCreation", "sform");
	AForm* rForm = intern.makeForm("RobotomyRequest", "rform");
	AForm* pForm = intern.makeForm("PresidentialPardon", "pform");
	AForm* eForm = intern.makeForm("error", "error");
